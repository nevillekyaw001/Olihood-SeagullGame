...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class AlbatrossScenario : ScenarioManager
	{
        ...
        protected override void Scenario()
		{
			...
			// in this scenario, we'll turn the wall spawner on at the 30s mark, and turn the rock one off - Neville
			//AddTimeEvent("00:00:30:000",()=> SwitchToWallsSpawner());
			// then after 1 minute we'll go back to the rock spawner - Neville 
			//AddTimeEvent("00:01:00:000",()=> SwitchToRocksSpawner());
			// and again back to the wall spawner at the 2 minute mark - Neville
